      ...
      <div className='max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8'>
        ...
        <div className='flex justify-center'>
          ...
          >
            <p className='me-2 text-white text-sm'>
              We are working to make this Open Source
            </p>
        ...
        <div className='max-w-3xl text-center mx-auto'>
          <h1 className='block font-medium text-gray-200 text-4xl sm:text-5xl md:text-6xl lg:text-7xl'>
            Promoting Data Driven Decisions and Insights
          </h1>
        </div>
        {/* End Title */}
        <div className='max-w-3xl text-center mx-auto'>
          <p className='text-lg text-white/70'>
            People-Workbook is a prototype that helps organizations that are data driven to collect and verify structured data, analyze it, and make data driven decisions.
          </p>
        </div>
        {/* Buttons */}
